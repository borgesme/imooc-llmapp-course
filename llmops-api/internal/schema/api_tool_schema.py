...
class GetApiToolProviderResp(Schema):
    ...
    headers = fields.List(fields.Dict, load_default=[])
    created_at = fields.Integer(load_default=0)
...
class GetApiToolResp(Schema):
    ...
    inputs = fields.List(fields.Dict, load_default=[])
...
class GetApiToolProvidersWithPageResp(Schema):
    ...
    description = fields.String()
    headers = fields.List(fields.Dict, load_default=[])
    tools = fields.List(fields.Dict, load_default=[])
    created_at = fields.Integer(load_default=0)
